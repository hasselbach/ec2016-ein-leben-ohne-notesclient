...
public class Main extends Application {
	...
	public class JavaApp {
		...
		public void sendEMail(String id, String name, String price){
			new SendEmail().execute(id, name, price);
		}
	}
	...
	public void start(Stage primaryStage) throws Exception {
		...
		webEngine.load(Main.class.getResource("/ec2016/demo11/application/index.html").toExternalForm());
